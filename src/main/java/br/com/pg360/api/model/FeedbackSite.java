...
public class FeedbackSite {
    ...
    public FeedbackSite(Long cdAvaliacao, String nmPessoa, String emailPessoa, String dsAvaliacao, LocalDate dtAvaliacao) {
        this.cdFeedback = cdAvaliacao;
