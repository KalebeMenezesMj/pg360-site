...
function CategoriaHome({ onSelect }) {
  const botoes = [
    { chave: "categorias-create", label: "Cadastrar", icon: <PlusCircle className="w-6 h-6 mb-2" /> },
    { chave: "categorias-list", label: "Listar", icon: <ListOrdered className="w-6 h-6 mb-2" /> },
    { chave: "categorias-edit", label: "Editar", icon: <Pencil className="w-6 h-6 mb-2" /> },
    { chave: "categorias-delete", label: "Excluir", icon: <Trash2 className="w-6 h-6 mb-2" /> },
  ];
