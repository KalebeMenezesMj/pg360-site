...
function EventoHome({ onSelect }) {
  const botoes = [
    { chave: "eventos-create", label: "Cadastrar", icon: <PlusCircle className="w-6 h-6 mb-2" /> },
    { chave: "eventos-list", label: "Listar", icon: <ListOrdered className="w-6 h-6 mb-2" /> },
    { chave: "eventos-edit", label: "Editar", icon: <Pencil className="w-6 h-6 mb-2" /> },
    { chave: "eventos-delete", label: "Excluir", icon: <Trash2 className="w-6 h-6 mb-2" /> },
  ];
